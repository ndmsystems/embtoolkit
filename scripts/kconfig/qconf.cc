	...
	: searchWindow(0)
{
	...
	snprintf(title, sizeof(title), _("Embtoolkit v%s Configuration"),
...
{
	static const QString str = _("Welcome to the qconf graphical kernel configuration tool for Embtoolkit.\n\n"
