...
# TARGET optimization
#
__TARGET_OPTIMIZATION	:= $(if $(CONFIG_EMBTK_TARGET_WITH_DEBUG_DATA),-g)
__TARGET_OPTIMIZATION	+= $(if $(CONFIG_EMBTK_TARGET_NONE_OPTIMIZED),-O0)
__TARGET_OPTIMIZATION	+= $(if $(CONFIG_EMBTK_TARGET_SPEED_OPTIMIZED),-O2)
__TARGET_OPTIMIZATION	+= $(if $(CONFIG_EMBTK_TARGET_SIZE_OPTIMIZED),-Os)
TARGET_OPTIMIZATION	:= $(strip $(__TARGET_OPTIMIZATION))
...
__TARGET_CFLAGS		+= $(TARGET_OPTIMIZATION)
